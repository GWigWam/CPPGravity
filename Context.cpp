...
void Context::init(unsigned int noObjs, unsigned long size, float timeFactor) {
    ...
    Entities.push_back(Entity(center, center, 0, 0, sun_m));                // sun      

    auto mer_apo = 69820;
    auto mer_x = center - mer_apo;
    auto mer_apo_spd = 0.03886;
    auto mer_m = 330110000000.0000000000000;                                // 3.3011e23kg
    Entities.push_back(Entity(mer_x, center, 0, mer_apo_spd, mer_m));       // mercury
    ...
    Entities.push_back(Entity(ven_x, center, 0, ven_spd, ven_m));           // venus
    ...
    Entities.push_back(Entity(earth_x, center, 0, earth_apo_spd, earth_m)); // earth
    ...
    Entities.push_back(Entity(moon_x, center, 0, moon_spd, moon_m));        // moon
    ...
    Entities.push_back(Entity(mars_x, center, 0, mars_spd, mars_m));        // mars
    ...
    Entities.push_back(Entity(jup_x, center, 0, jup_spd, jup_x));           // jupiter
    ...
    Entities.push_back(Entity(sat_x, center, 0, sat_spd, sat_m));           // saturn
    ...
    Entities.push_back(Entity(ura_x, center, 0, ura_spd, ura_m));           // uranus
    ...
    Entities.push_back(Entity(nep_x, center, 0, nep_spd, nep_m));           // neptune
}
